    ...
    return `
      <section class="opx-video-panel anim" data-theme="${item.theme}" data-video-panel="1">
        <div class="opx-video-inner">
          <video class="opx-motion-video" autoplay muted loop playsinline preload="metadata" poster="assets/motion/${item.video}.jpg">
            <source src="assets/motion/${item.video}.mp4" type="video/mp4">
          </video>
