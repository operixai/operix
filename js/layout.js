...
<div class="mobile-menu" id="mobileMenu">
  ...
  <div class="mobile-menu-bottom">
    ...
    <a href="contact.html" class="btn btn-primary" style="width:100%;justify-content:center" data-t="nav_cta"></a>
  </div>
</div>`;
...
<footer>
  <div class="footer-top">
    ...
    <div class="footer-col">
      ...
      <ul>
        <li><a href="https://t.me/exyysdof" target="_blank" data-t="footer_tg"></a></li>
  ...
  <div class="footer-bottom">
    ...
    <p><a href="privacy.html" style="color:inherit;text-decoration:none" data-t="footer_privacy"></a> · <a href="terms.html" style="color:inherit;text-decoration:none" data-t="footer_terms"></a></p>
  </div>
</footer>`;
    ...
    if (btn && menu) {
      ...
      menu.querySelectorAll('a').forEach(a => {
        a.addEventListener('click', () => {
          ...
          btn.innerHTML = '<svg width="22" height="22"><use href="#i-menu"/></svg>';
        });
      });
    }
  }, 50);
